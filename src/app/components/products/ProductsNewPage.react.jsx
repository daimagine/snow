...
var ProductsNewPage = React.createClass({
	...
	getInitialState: function() {
    	console.log('ProductsNewPage.react: getInitialState')
		return {
		}
	},

	componentDidMount: function() {
    	console.log('ProductsNewPage.react: componentDidMount')
	},

	componentWillUnmount: function() {
    	console.log('ProductsNewPage.react: componentWillUnmount')
	},
			        ...
			        <div className="col-sm-6">
			          ...
			          <div className="form-group">
			            <div className="checkbox check-default">
		                    <input id="affiliateReady" name="affiliateReady" type="checkbox" value="0" />
				...
				<div className="col-xs-12">
	              <div className="grid simple">
	                <div className="grid-title">
	                  <h3>Tambah <span className="semi-bold">Product</span></h3>
	                </div>
...
module.exports = ProductsNewPage;